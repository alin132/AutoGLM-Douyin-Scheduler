export const en = {
  ...
  deviceSidebar: {
    ...
    refresh: 'Refresh',
    historyDescription:
      'Click a history record to quick-fill IP address. Since wireless debugging ports may change, please confirm the port before connecting.',
  ...
  deviceCard: {
    ...
    forceRelease: 'Force Release Device Lock',
    forceReleaseError: 'Force release failed',
  ...
  douyinComment: {
    ...
    searchKeywordsLabel: 'Search Keywords (one per line)',
    searchKeywordsPlaceholder: 'One keyword per line',
    searchKeywordsExamplePlaceholder:
      'Mushroom recipe\nTremella soup\nMushroom stew',
    searchKeywordsHint: 'Randomly select one keyword for each execution',
    searchMode: 'Search Mode',
    searchModeKeyword: 'Keyword Search',
    searchModeDouyinIndex: 'Douyin Index',
    searchModeHint:
      'Keyword Search: Search keywords directly in Douyin; Douyin Index: Search videos via Douyin Index mini-program',
    douyinIndexFilterConfig: 'Douyin Index Filter Config',
    douyinIndexPublishTime: 'Publish Time',
    douyinIndexPublishTimeDefault: 'No Limit',
    douyinIndexPublishTime3Days: 'Last 3 Days',
    douyinIndexPublishTime7Days: 'Last 7 Days',
    douyinIndexPublishTimeMonth: 'Last Month',
    douyinIndexFilterHint:
      'Douyin Index mode searches videos via mini-program, likes and sort filters are not supported',
    publishTime: 'Publish Time',
    publishTimeDefault: 'No Limit',
    publishTimeDay: 'Last 24 Hours',
    publishTimeWeek: 'Last 7 Days',
    publishTimeHalfYear: 'Last 6 Months',
    videoSort: 'Video Sort',
    videoSortLatest: 'Latest',
    videoSortMostLiked: 'Most Liked',
    videoSortDefault: 'Default',
    // Video filter
    ...
    interactionSectionTitle: 'Watch & Interact',
    watchVideo: 'Watch Video',
    watchDurationRatio: 'Watch Ratio',
    watchDurationRatioLabel: 'Watch Duration Ratio',
    ...
    commentModeDirect: 'Direct Comment (based on video content)',
    commentModeReply: 'Reply to Comment (reply to others)',
    ...
    targetQuestionComments: 'Prioritize Q&A Comments',
    targetRegionsLabel:
      'Target Region IP (click to select, empty for no limit)',
    noLimit: 'No Limit',
    selectedRegionsCount: '{count} regions selected',
    multiSelect: 'Multi-select',
    searchRegionPlaceholder: 'Search regions…',
    clearSelection: 'Clear selection',
    replyIntervalMin: 'Reply Interval (Min)',
    replyIntervalMax: 'Reply Interval (Max)',
    replyIntervalMinSeconds: 'Reply Interval (sec) Min',
    replyIntervalMaxSeconds: 'Reply Interval (sec) Max',
    secondsUnit: 'sec',
    // Content config
    contentConfig: 'Content Config',
    useAi: 'Use AI Generation',
    useAiReply: 'Use AI to generate replies',
    useAiHint:
    ...
    styleKocNatural: 'KOC Style (Natural, conversational)',
    ...
    replyTemplatesLabel: 'Reference Examples (Q&A format, one per line)',
    replyTemplatesPlaceholder:
      'How much does this cost (Ans: 50-60k)\nWhere is the address (Ans: Fujian, Fuzhou)\nDo you serve XX area (Ans: Sure)',
    // Execution config
    ...
    videoIntervalMinSeconds: 'Video Interval (sec) Min',
    videoIntervalMaxSeconds: 'Video Interval (sec) Max',
    // Cron config
    cronExpression: 'Cron Expression',
    ...
    scheduleEvery: 'Every',
    scheduleOnce: 'per run',
    scheduleEndTime: 'End Time',
    scheduleNoLimitPlaceholder: 'No Limit',
    scheduleEndTimeHint: 'Stop scheduling after this time',
    intervalMinutes: '{value} min',
    intervalHours: '{value} hr',
    clear: 'Clear',
    // Status
    enabled: 'Enabled',
    disabled: 'Disabled',
    ...
    disable: 'Disable',
    runNow: 'Run Now',
    autoPausedShort: 'Auto-paused',
    consecutiveFailuresShort: 'Failures',
    // History
    history: 'History',
